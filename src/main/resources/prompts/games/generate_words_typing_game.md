...
Generate **%%amountOfQuestions%%** word-clue pairs where:
- **word**: Use a word from the provided list
- **clue**: A clear and concise hint in **%%generativeContentLanguage%%** language that helps the user guess the word. Do not include the word itself in the clue.
