...
class AIFixtureRegistry {
    private val entries: Map<String, AIFixtureEntry> = listOf(
        ...
        AIFixtureEntry(
            operationKey = AiProviderUsageOperationType.Words.GENERATE_MANUAL,
            type = AIFixtureType.STRUCTURED,
            isDynamic = true,
            resourcePath = "",
        ),
        AIFixtureEntry(
            operationKey = AiProviderUsageOperationType.Words.FILL_GAPS,
            type = AIFixtureType.STRUCTURED,
            isDynamic = true,
            resourcePath = "",
        ),
        AIFixtureEntry(
            operationKey = AiProviderUsageOperationType.Game.Generate.CROSSWORD,
            type = AIFixtureType.STRUCTURED,
            isDynamic = true,
            resourcePath = "",
        ),
        AIFixtureEntry(
            operationKey = AiProviderUsageOperationType.Game.Generate.WORDS_TYPING,
            type = AIFixtureType.STRUCTURED,
            isDynamic = true,
            resourcePath = "",
        ),
        AIFixtureEntry(
            operationKey = AiProviderUsageOperationType.Game.Generate.SENTENCES_WRITING,
            type = AIFixtureType.STRUCTURED,
            isDynamic = true,
            resourcePath = "",
        ),
        AIFixtureEntry(
            operationKey = AiProviderUsageOperationType.Game.Review.SENTENCES_WRITING,
            type = AIFixtureType.STRUCTURED,
            isDynamic = true,
            resourcePath = "",
        ),
