...
data class ReviewedUserConversationMessage(
    ...
    companion object {
        val JSON_SCHEMA = mapOf(
            "type" to "object",
            "properties" to mapOf(
                "sabotage" to mapOf(
                    "type" to listOf("string", "null"),
                    "description" to "Detects sabotage... Return string with reason... Otherwise null."
                ),
                "grammar" to mapOf(
                    "type" to "integer",
                    "minimum" to 0,
                ...
                "alternativeExpressions" to mapOf(
                    ...
                    "items" to mapOf(
                        ...
                        "properties" to mapOf(
                            ...
                            "note" to mapOf(
                                "type" to listOf("string", "null"),
                                "description" to "Optional: nuances between alternatives"
                            )
                        ),
                        "required" to listOf("context", "alternatives"),
                        "additionalProperties" to false
                    ),
                ...
                "culturalNote" to mapOf(
                    "type" to listOf("string", "null"),
                    "description" to "Grammatically correct but culturally inappropriate usage. Null if fine."
                )
            ),
            "required" to listOf(
                "sabotage",
